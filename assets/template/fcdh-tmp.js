 ...
 */
 // 全局变量，可以自己配置
var _ajaxsearch='{{scodeurl}}ajax_search.php'; // 搜索远程数据
var _ajaxurl='{{scodeurl}}ajax.php';  // 下载或上传到远程数据网址
var _ajaxstate='{{scodeurl}}ajax_state.php'; // 设置url状态
...
var _pagename=null;
var _thisSearch='search.html?{{sotype}}='; // 默认搜索引擎
var now = -1;
var resLength = 0;

...
class CaptchaBuilder implements CaptchaBuilderInterface
{
     ...
     * @var string 随机字符
     */
    protected $characters = '2346789abcdefghjkmnopqrstuvwxyzABCDEFGHJKLMNOPQRSTUVWXYZ';
    /**
     * @var int 图片宽度
     */
    protected $width = 160;
    ...
    public function initialize(array $config){
        ...
        $this->fontSize = intval($this->width / floatval($this->number*1.4));
    ...
    public function create()
    {
        ...
        for ($i = 0; $i < $this->number; $i++) {
			...
			if($i==0) $codeNX += mt_rand($this->fontSize * 0.6, $this->fontSize * 1.0);
			else  $codeNX += mt_rand($this->fontSize * 1.0, $this->fontSize * 1.4);
            ...
            imagettftext($this->image, $this->fontSize, mt_rand(-30, 30), $codeNX, $this->fontSize * 1.2, $color, $this->textFont, $code[$i]);
        }

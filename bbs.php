    ...
    <div id="container">
        ...
        <div class="content">
			...
			<form id="myform">
				...
				<p>
				<label><a class="c2"><i class="fa-bookmark"></i> 电子邮箱</a> <a href="youxiang.html" title="免费电子邮箱申请"class="ti-more"target="_blank">◆邮箱申请 &raquo;</a> <strong id="info"class="c2"></strong></label><input type="text" class="form-control" name="email"maxlength="21"style="width:100%" id="email" placeholder="电子邮箱，方便回复您"></p>
				<p>
            ...
            <footer class="footer">
                    <div class="vcenter">
                         Since 2020 <strong><a href="./">fcdh.net</a></strong> <span class="ti-more"><a href="https://beian.miit.gov.cn/">渝ICP备20001609号</a>
                    </div>
                    <div id="go-up">
